...
export const PRODUCTS = [
  ...
  { id: 'chocolate-orange-cake', name: 'Chocolate Orange Cake', note: 'orange, chocolate & love', cat: 'chocolate', img: 'img/card-chocolate-orange.webp', plate: 'img/card-chocolate-orange.webp', bg: '#d98c7a', ink: '#22060a', alt: 'Slice of layered chocolate orange cake with candied orange' },
